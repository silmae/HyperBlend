...
"""Top level folder where rendered images of slab simulation 
are saved in their own subdirectories."""

dirname_optimization_results = "Optimization results"
"""Wavelength-wise results for each signal solved by optimization 
method are stored here (numerical and png images)."""
...
"""Simulated result signal of a slab simulation. This is postfixed with the 
signal id by :mod:`file_names`."""
...
"""Wavelength-wise standard deviation of modeled reflectance. 
Set to zero is only one sample was used. """

key_set_result_wl_t_std = "set_result_wl_t_std"
"""Wavelength-wise standard deviation of modeled transmittance. 
Set to zero is only one sample was used. """

key_set_result_wl_rm_std = "set_result_wl_rm_std"
"""Wavelength-wise standard deviation of measured reflectance. 
Set to zero is only one sample was used. """

key_set_result_wl_tm_std = "set_result_wl_tm_std"
"""Wavelength-wise standard deviation of measured transmittance. 
Set to zero is only one sample was used. """

key_set_result_wl_re_std = "set_result_wl_re_std"
"""Wavelength-wise standard deviation of reflectance error. 
Set to zero is only one sample was used. """

key_set_result_wl_te_std = "set_result_wl_te_std"
"""Wavelength-wise standard deviation of transmittance error. 
Set to zero is only one sample was used. """

key_set_result_wl_ad_std = "set_result_wl_ad_std"
"""Wavelength-wise standard deviation of absorption particle density. 
Set to zero is only one sample was used. """

key_set_result_wl_sd_std = "set_result_wl_sd_std"
"""Wavelength-wise standard deviation of scattering particle density. 
Set to zero is only one sample was used. """

key_set_result_wl_ai_std = "set_result_wl_ai_std"
"""Wavelength-wise standard deviation of scattering anisotropy. 
Set to zero is only one sample was used. """

key_set_result_wl_mf_std = "set_result_wl_mf_std"
"""Wavelength-wise standard deviation of mix factor. 
Set to zero is only one sample was used. """
