...
def render_reflectance(wl, value):
    ...
    combine_rgb = bpy.data.materials["Reflectance white"].node_tree.nodes["Combine RGB"]
    combine_rgb.mode = "HSV"
    combine_rgb.inputs[0].default_value = 0
    combine_rgb.inputs[1].default_value = 0
    combine_rgb.inputs[2].default_value = value
