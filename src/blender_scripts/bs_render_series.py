...
if __name__ == '__main__':
    ...
    parser.add_argument(key_wavelength[0], key_wavelength[1], dest=key_wavelength[1], action="store",
                        required=True, type=str,
                        help="List of wavelengths.")

    parser.add_argument(key_abs_dens[0], key_abs_dens[1], dest=key_abs_dens[1], action="store", type=str,
                        required=True, help="List of Shader volume absorption node's density input.")

    parser.add_argument(key_scat_dens[0], key_scat_dens[1], dest=key_scat_dens[1], action="store", required=True, type=str,
                        help="List of Shader volume scattering node's density input.")

    parser.add_argument(key_scat_ai[0], key_scat_ai[1], dest=key_scat_ai[1], action="store", required=True, type=str,
                        help="List of Shader volume scattering node's anisotropy input.")

    parser.add_argument(key_mix_fac[0], key_mix_fac[1], dest=key_mix_fac[1], action="store", required=True, type=str,
