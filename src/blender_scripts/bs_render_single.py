...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        required=True,
        help="Shader volume absorption node's density input.",
    )
    ...
    parser.add_argument(
        ...
        choices=Range(0.0, 3000.0),
        required=True,
        help="Shader volume scattering node's density input.",
    )
    ...
    parser.add_argument(
        ...
        required=True,
        help="Shader volume scattering node's anisotropy input.",
    )
