...
from data import toml_handling as T
from slab_model.training_utils import get_starting_guess_points
...
from utils.spectra_utils import make_linear_test_target
...
def generate_starting_guess(solver_name: str = None):
    ...
    plotter._plot_starting_guess_coeffs_fitting(solver_name=solver_name)


def fit_starting_guess_coefficients(degree=4, set_name: str = None, solver_name: str = None):
    ...
    :param set_name: Custom set name to fetch the data from. If not given, default set name variable
    ...
    T.write_starting_guess_coeffs(ad_coeffs, sd_coeffs, ai_coeffs, mf_coeffs, solver_name=solver_name)
